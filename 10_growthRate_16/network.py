...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.RDB1 = RDB(nChannels=64, nDenselayer=4, growthRate=16)
        self.RDB2 = RDB(nChannels=64, nDenselayer=5, growthRate=16)
        self.RDB3 = RDB(nChannels=64, nDenselayer=5, growthRate=16)
