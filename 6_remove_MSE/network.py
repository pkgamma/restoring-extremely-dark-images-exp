...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv_rdb8x = conv_layer(int(64//16), 192, kernel_size=3, groups=1, bias=True, negative_slope=0.2, bn=False, init_type='kaiming', fan_type='fan_in', activation='after', pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization = True)
    ...
    def forward(self,low):
        ...
        cat_32_8 = self.conv32_8_cat(rdb8x)
