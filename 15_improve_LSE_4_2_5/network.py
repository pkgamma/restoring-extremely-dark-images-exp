...
class ResBlock(nn.Module):    
    def __init__(self,in_c):
        ...
        self.conv1 = conv_layer(in_c, in_c//2, kernel_size=3, groups=1, bias=True, negative_slope=0.2, bn=False, init_type='kaiming', fan_type='fan_in', activation='after', pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization = True)
        
        self.conv2 = conv_layer(in_c//2, in_c, kernel_size=3, groups=1, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization = True)
...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.RDB1 = RDB(nChannels=64, nDenselayer=4, growthRate=24)
        self.RDB2 = RDB(nChannels=64, nDenselayer=5, growthRate=24)
        self.RDB3 = RDB(nChannels=64, nDenselayer=5, growthRate=24)
        ...
        self.conv_rdb2x = nn.Sequential(
        #                conv_layer(64, 192, kernel_size=3, groups=1, bias=True, negative_slope=0.2, bn=False, init_type='kaiming', fan_type='fan_in', activation='after', pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization = True),
                        self.up4) 
        ...
        conv_layer(4, 12, kernel_size=3, groups=1, bias=True, negative_slope=0.2, bn=False, init_type='kaiming', fan_type='fan_in', activation='after', pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization = True),
        conv_layer(12, 4, kernel_size=3, groups=1, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization = True)
                        )  
        ...
        self.conv_2_8_32 = conv_layer(12, 12, kernel_size=5, groups=1, bias=True, negative_slope=1, bn=False, init_type='kaiming', fan_type='fan_in', activation=False, pixelshuffle_init=False, upscale=False, num_classes=False, weight_normalization = True)
    ...
    def forward(self,low):
        ...
        # 2x branch starts
        low2x = torch.cat((self.conv2x(low2x),low8x, rdb2x),dim=1)
