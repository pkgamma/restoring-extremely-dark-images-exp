...
macs, params = get_model_complexity_info(model_fb2, (12, H//2,W//2), as_strings=True,
                                       print_per_layer_stat=False, verbose=False)
...
macs, params = get_model_complexity_info(model_fb1, (64, H//8,W//8), as_strings=True,
                                       print_per_layer_stat=False, verbose=False)
...
with torch.no_grad():
    ...
    tensor = torch.rand(1, 12, H//2,W//2)
    beg=time.time()
    for i in range(5):
        model_fb2(tensor)
